...
import { bishopLine, bishopPin } from "./piece-moves/bishop.js"
import { queenLine, queenPin } from "./piece-moves/queen.js"
import { rookLine, rookPin } from "./piece-moves/rook.js"
import ShowReviewButton from "./review.js"
import { addClass, board, buttonUndo, checkMate, defeatedIcon, endGameByCheckMate, getColor, getPieces, getPiecesByColor, getSquare, getType, opponent, piecesCheck, setCheck, winnerIcon } from "./variables.js"
 ...
 */
export const setPiecesCheck = (square, opponentColor = opponent()) => {
    getPiecesByColor(opponentColor).forEach(piece => {
