...
export default function KnightCaptures(piece) {
    let square = getSquare(piece)
    let [c, r] = square.split("")

    let squares = [
        ...CaptureSquares(square, "up-left", knightColumns1(c), knightRanks2(r)),
        ...CaptureSquares(square, "up-left", knightColumns2(c), knightRanks1(r)),

        ...CaptureSquares(square, "up-right", knightColumns1(c), knightRanks2(r)),
        ...CaptureSquares(square, "up-right", knightColumns2(c), knightRanks1(r)),

        ...CaptureSquares(square, "down-right", knightColumns1(c), knightRanks2(r)),
        ...CaptureSquares(square, "down-right", knightColumns2(c), knightRanks1(r)),

        ...CaptureSquares(square, "down-left", knightColumns1(c), knightRanks2(r)),
        ...CaptureSquares(square, "down-left", knightColumns2(c), knightRanks1(r)),
    ]
