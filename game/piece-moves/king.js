import { getPossibleCaptures } from "../available-moves.js"
import { check, columns, getColor, getPieceBySquare, getSquare, getType, isFirstMove, ranks, squareHasPiece } from "../variables.js"
import { getCaptures, getMoves, getPossibleCaptureSquares } from "./available-squares.js"
...
export const kingMoves = piece => {
    ...
    let columnsInPossibleCastle = check ? kingColumns(c) : kingCastleColumns(c, r, piece)
    ...
    let squares = [
        ...
        ...getMoves(square, "right", columnsInPossibleCastle, []),
        ...
        ...getMoves(square, "left", columnsInPossibleCastle, []),
    ]
